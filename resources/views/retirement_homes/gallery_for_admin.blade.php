                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="hidden" value={{$data['user_id']}} name="retirement_home_user_id" id="retirement_home_user_id">
                                <form method="POST" action="/my-account/upload-gallery/{{$data['user_id']}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
