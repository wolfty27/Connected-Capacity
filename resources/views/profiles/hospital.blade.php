                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h5 class="page-title">Hospital Profile</h5>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <div class="avatar-lg">
                                                    <img src={{$data['logo']}} alt="" class="rounded-circle" height="80" width="80">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="name" placeholder="Enter Your Name" class="form-control" value="{{ $data['name'] }}" disabled>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="email" name="email" placeholder="Enter Your Email" class="form-control" disabled value="{{ $data['email'] }}">
                                                                    </div>
                                                                </div>
...
{{--                                                                </div>--}}
                                                                ...
                                                                {{-- <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="timezone" placeholder="12:12:12 PM" class="form-control" value="{{ $data['timezone'] }}">
                                                                    </div>
                                                                </div> --}}
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        <label for="cusername" class="form-label">Calendly User Name </label>
                                                                        <input disabled type="text" name="calendly" placeholder="Calendly Username" class="form-control" value="{{ $data['calendly'] }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
