                ...
                <div className="flex justify-between items-center max-w-7xl mx-auto">
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="p-2 rounded-lg text-slate-500 hover:text-teal-600 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-colors"
                        ...
                        <button
                            ...
                            className="px-3 py-1.5 text-sm font-medium text-teal-700 hover:text-teal-900 hover:bg-teal-50 rounded-lg transition-colors flex items-center gap-1.5"
                        >
                    ...
                    {/* Right side - Logo, User info and actions */}
                    <div className="flex items-center gap-4">
                        {/* Logo - Text Based - moved to right */}
                        <div className="flex flex-col items-center leading-none cursor-pointer mr-4" onClick={() => navigate('/care-dashboard')}>
                        ...
                        {/* Notifications */}
                        <button className="relative p-2 text-slate-400 hover:text-teal-600 hover:bg-slate-100 rounded-lg transition-colors">
                        ...
                        {user && (
                            <button
                                ...
                                className="text-slate-500 hover:text-rose-600 hover:bg-rose-50 font-medium rounded-lg text-sm px-3 py-2 transition-colors"
                            >
                                Logout
                            </button>
                        )}
