...
class DemoAssessmentsSeeder extends Seeder
{
    ...
    protected function getAssessmentProfile(string $targetRug): array
    {
        return match ($targetRug) {
            // Special Rehabilitation - high therapy minutes
            'RA1' => [
                'maple_score' => '4',
                'adl_hierarchy' => 3,
                'iadl_difficulty' => 5,
                ...
                'raw_items' => $this->buildRawItems([
                    ...
                    'adl_bathing' => 4, 'adl_locomotion' => 4, 'adl_eating' => 1,
                ]),
            ],

            // Extensive Services - dialysis
            'SE1' => [
                'maple_score' => '5',
                'adl_hierarchy' => 4,
                'iadl_difficulty' => 6,
            ...
            // Reduced Physical Function - mid ADL
            'PB0' => [
                'maple_score' => '3',
                'adl_hierarchy' => 2,
                'iadl_difficulty' => 4,
                ...
                'raw_items' => $this->buildRawItems([
                    'adl_bathing' => 3, 'adl_locomotion' => 2, 'adl_eating' => 1,
                ]),
            ],

            // Reduced Physical Function - lowest ADL (default)
            default => [
                'maple_score' => '2',
                'adl_hierarchy' => 1,
                'iadl_difficulty' => 2,
